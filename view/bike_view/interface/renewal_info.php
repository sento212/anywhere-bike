<?php
namespace Renawal;
function tampilan($tampilan, $user_id, $mkg_group,$data,$UWD_HOLD_list,$UWD_HOLD_date,$UWD_HOLD_list_select,$UWD_HOLD_text,$insurend,$UWD_HOLD_text_area,$butt_off_view,$result_Simul_to_pol_quo,$UWD_HOLD_button){
    $dat = $data[data][0];
    $disabled_renewal = "";
    if ($user_id == 'mks')
    {
...
<script src='https://www.rks-w.com/mks/entry/bike/views/javascript/renawal_info.js' ></script>
