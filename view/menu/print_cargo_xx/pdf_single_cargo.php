...

{
    ...
    $duit_dalam_INDONESIA = $response_decode['angka_convert'];
    $number_with_comma = str_replace('.', ',', $duit_dalam_INDONESIA);
...
// untuk jumlah premi calculation
{
    $curl = curl_init();
    $arr_data_terbilang = array
    (
...
//===============
  ...
  if ((int)$toint != 0)
  {
        ...
        curl_close($url);
        $rata1_after = json_decode($result_data1_after, TRUE);
        $terbilang_eng_after_2 = $rata1_after['angka_convert'];
      //
        $arr_data2  = array(
          "nilai"  => (int)$toint,
          "currency" => 'IDR',
...
if($status == "ori")
{
    ...
    $cover_single = '<table border="" cellspacing="" cellpadding="" > <tr>';
    $cover_single .= '
    ...
    <td style="font-size:10; width:240;" ><b>' . $polis_single . '</b></td>
    </tr>
    <tr>
    <td></td>
    ...
    $pdf->AddPage();
    $pdf->writeHTML($cover_single, true, false, true, false);
    ...
    $html .='
        <td width="330">Reference No. &nbsp;&nbsp;:' . $no_ref . '<br>(<i>No. Referensi</i>)</td>
        </tr>
            <tr>
            <td>Name Of The Insured<br>(<i>Nama Tertanggung</i>)<br></td>
            <td style="width:15" align="right">:</td>
        ...
        <tr>
            ...
            <td style="width:15" align="right">:</td>
            <td style="width:450" align="left">' . $car_voyage . '</td>
            <td ></td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:15" align="right">:</td>
            <td colspan="8" style="width:500" ><i>'.$vessel.''. $car_conveyage .'<br> </i> <br> Year : &nbsp;'.$vessel_year.'&nbsp; &nbsp; GRT : &nbsp;'.$vessel_grt.'&nbsp; &nbsp; Class : &nbsp;'.$class_vess.'&nbsp; &nbsp; Cons : &nbsp;'.$vessel_const.' </td>
        </tr>
    
        <tr>
            <td>Estimated Departure Date<br>(<i>Perkiraan Tanggal Keberangkatan</i>)<br></td>
            <td style="width:15" align="right">:</td>
            <td  style="width:500">' . date("j F Y", strtotime($estimasi)) . '</td>
        </tr>
        ...
        else
        {
            ...
            <tr>
                <td>Total Sum Insured<br>(<i>Total Harga Pertanggungan</i>)<br></td>
                <td style="width:15" align="right">:</td>
                <td  style="width:500">' . $currency_code . '&nbsp;' .(number_format($sum_ins, 2)) . '</td>
            </tr>';
        }
    
        if ($terbilang_eng_after_2 == '')
        {
            $dan  = '';
            $and  = '';
            $sen  = '';
        ...
        <tr>
            ...
            <td style="width:15" align="right">:</td>
            <td style="width:420" align="justify">('.$currency_code.'&nbsp; :'.$angka_luar_luar_anjg.''.$and.''.$terbilang_eng_after_2.'  '.$cent.' only)<br>('.$currency_code.'&nbsp; :'.$duit_dalam_INDONESIA_AA.'&nbsp;'.$dan.'&nbsp;'.$terbilang_ina_after_2.''.$sen.')</td>
        </tr>
    ...
    <tr>
        ...
        {   
            $accept .='
            <td style="width:250">'.$currency_code.'&nbsp;'.number_format($si_amount).''.$hit.'</td>
            <td>=&nbsp;'.$currency_code.'&nbsp;&nbsp;&nbsp;'.number_format($gpr_amount).'</td>';
        }
    ...
    <tr>
        ...
        <td width="80%"><i>('.$currency_code.' : ' .$terbilang_ina . ' '.$dan.' '.$terbilang_ina_after.' '.$sen.')</i></td>
    </tr>
    </table>';
    ...
    $pageCount = $pdf->setSourceFile('mix_all_Cargo/new_wording_2.pdf');
...
// ob_clean();
// echo 2345;
$pdf->Output(  $_SERVER['DOCUMENT_ROOT'] . "mks/entry/view/menu/print_cargo/pdf_cargo/" . $file_name_pdf ,'F');
echo json_encode("https://www.rks-m.com/mks/entry/view/menu/print_cargo/pdf_cargo/".$file_name_pdf);
