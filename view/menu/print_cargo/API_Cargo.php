...
// -------------------------<>---------------------------------------------- 
{
    ...
    $data_unit_premi  = json_decode($result_unit, true);

    foreach ($data_unit_premi ['code'] as $premi_cal)
    {
...
// -------------------------<>----------------------------------------------
{
    ...
    $data_unit  = json_decode($result_unit, true);
    $data_unit_cargo  = json_decode($result_unit, true);
...
// API DEBIT NOTA 
{   
    $encode_nota = json_encode($nota_multi,true);
