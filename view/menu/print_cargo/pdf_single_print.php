...
// // https://www.rks-w.com/mks/entry/print_cargo/pdf_single_print.php
//api_hvc_main
ob_end_clean();
...
<table border="" cellspacing="" cellpadding="">
  ...
  <tr>
    ...
    <td width="120" rowspan="3"  style="text-align:right;"><img src="https://www.araksa.com/mks/epol/hvc/image/TTD_auto.png" ></td>
  </tr>
    ...
    <tr>
      ...
      foreach ($hvc_clauses['code'] as $row)
      {
        ...
        <tr  style = "font-size:12px" >
            <th width = "300"><b>' . $row['CLAUSE_TITLE_ENGLISH'] . '</b></th>
            <th width = "17"></th>
...
echo json_encode("https://www.rks-w.com/mks/entry/print_cargo/mix_all_Cargo/".$file_name_pdf);
