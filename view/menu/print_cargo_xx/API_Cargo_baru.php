...
//  https://www.rks-w.com/mks/entry/print_cargo/API_Cargo_baru.php
...
// exit();
    ...
    if($tot_isi_obj_cargo == 1)
    {
        ...
        // for($i = 0; $i <= $tot_isi_obj_cargo; $i++)
        {
            ...
            $nota_single  = $no_nota;
            // echo json_encode($isi_main_cargo);
